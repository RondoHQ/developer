...
Only active youth members participate in family grouping. Former members are excluded even when they still owe a fee for the selected season, and changing a member's former-member status invalidates the stored fee and family position for the entire household. Individual field updates find household members through the primary postal-code row and then compare the complete normalized family key; they do not scan the complete people collection.
